<?php
/**
 * https://github.com/WPTRT/code-examples
 *
...
function theme_slug_register_customizer_control_custom_radio_image( $wp_customize ){
	...
	$wp_customize->add_section( 'wordcamp_sp_layout', array(
			'title'	=> esc_html__( 'Layout', 'wordcamp_sp' ),
	...
	$wp_customize->add_control(
		...
		// $wp_customize object
			...
			array(
				...
				'section'		=> 'wordcamp_sp_layout',
				'label'			=> __( 'Blog Layout', 'theme-slug' ),
				'description'	=> __( 'Select the layout for the blog.', 'theme-slug' ),
				'choices'		=> array(
					'one-column' 		=> get_template_directory_uri() . '/assets/images/1c.png',
					'two-column' 		=> get_template_directory_uri() . '/assets/images/2c.png'
				)
			)
		)
	);
